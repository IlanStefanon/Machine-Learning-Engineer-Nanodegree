...
def explore_city_data(city_data):
	...
	# Calculate mean?
	print "Mean value :",    housing_prices.mean()
	# Calculate median?
	print "Median value :",    np.median(housing_prices)
	# Calculate standard deviation?
	print "Standard Deviation value :",    housing_prices.std()
...
def performance_metric(label, prediction):
	...
	return sqrt(mean_squared_error(label, prediction))
...
def fit_predict_model(city_data):
	...
	reg = GridSearchCV(regressor, param_grid=parameters,scoring=rmse_scorer, cv=3)
